    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm print:p-0 print:bg-white">
        <motion.div
          ...
          className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-2xl flex flex-col max-h-[92vh] overflow-hidden shadow-2xl print:border-none print:shadow-none print:w-full print:max-w-none print:max-h-none print:bg-white text-white print:text-black"
        >
              ...
              <div className="bg-slate-800 p-0.5 rounded-lg flex items-center text-xs">
                <button
                  ...
                  className={`px-2.5 py-1 rounded-md font-semibold transition-all ${
                    !is58mm ? 'bg-yellow-500 text-black shadow' : 'text-slate-400 hover:text-white'
                  }`}
                >
                  80mm Standart
                </button>
          ...
          <div className="flex-1 overflow-y-auto p-6 flex justify-center bg-slate-950/40 print:p-0 print:bg-white">
            <div
            ...
            >
              ...
              <div className="text-center pb-2 border-b border-dashed border-slate-400 mb-2">
                ...
                <p className="text-[10px] text-slate-600 mt-0.5">{metrics.sessionNumber}</p>
              </div>

              {/* Oturum Bilgileri */}
              <div className="space-y-0.5 pb-2 border-b border-dashed border-slate-400 mb-2 text-[11px]">
                ...
                <div className="flex justify-between">
                  <span className="text-slate-600">Kasa Durumu:</span>
              ...
              <div className="pb-2 border-b border-dashed border-slate-400 mb-2">
                <p className="text-center font-bold text-[11px] mb-1.5 uppercase tracking-wide bg-slate-100 py-0.5">
                  --- NAKİT KASA AKIŞI ---
                </p>
              ...
              <div className="pt-2 pb-3 text-[10px]">
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <p className="text-slate-600">Kasiyer İmza</p>
                    <p className="mt-5 border-b border-slate-400"></p>
                    <p className="text-[9px] mt-1 font-semibold">{metrics.closedBy || metrics.openedBy || 'Kasiyer'}</p>
                  </div>
                  <div>
                    <p className="text-slate-600">Mağaza Yetkilisi</p>
                    <p className="mt-5 border-b border-slate-400"></p>
              ...
              {/* Alt Bilgi */}
              <div className="text-center text-[9px] text-slate-500 pt-1 border-t border-dashed border-slate-300">
          ...
          <div className="p-4 border-t border-slate-800 flex items-center justify-between bg-slate-950/80 print:hidden">
            <button
              onClick={handleCopy}
