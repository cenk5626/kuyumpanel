...
import { LayoutDashboard, Users, LogOut, Activity, ChevronLeft, Menu, Package, ArrowLeftRight, Truck, ScanBarcode, UserCheck, History, Building, TrendingUp, ClipboardCheck, FileSpreadsheet, BellRing, Bot, Settings, CalendarClock, ReceiptText, Flame } from 'lucide-react';
...
export default function Sidebar({
  ...
  let allowedPermissions: string[] = ['dashboard', 'prices', 'stocks', 'transactions', 'suppliers', 'customers', 'installments', 'invoices', 'workshop', 'z-report', 'balance-sheet', 'stock-audit', 'data-hub', 'alerts', 'ai-assistant', 'settings-ai', 'logs', 'price-check', 'users'];
  if (role !== 'SUPER_ADMIN' && userPermissionsRaw) {
    try {
      ...
      allowedPermissions = ['dashboard', 'prices', 'stocks', 'transactions', 'suppliers', 'customers', 'installments', 'invoices', 'workshop', 'z-report', 'balance-sheet', 'stock-audit', 'data-hub', 'alerts', 'ai-assistant', 'settings-ai', 'logs', 'price-check', 'users'];
    }
  }
