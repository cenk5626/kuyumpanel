...
import { LayoutDashboard, Users, LogOut, Activity, ChevronLeft, Menu, Package, ArrowLeftRight, Truck, ScanBarcode, UserCheck, History, Building, TrendingUp, ClipboardCheck, FileSpreadsheet, BellRing, Bot, Settings, CalendarClock, ReceiptText, Flame, GitFork, ArrowRightLeft, Boxes, HeartHandshake, FileText, Wrench, MessageSquareShare, BadgePercent, LineChart } from 'lucide-react';
...
export default function Sidebar({
  ...
  let allowedPermissions: string[] = ['dashboard', 'prices', 'stocks', 'transactions', 'suppliers', 'purchases', 'customers', 'loyalty', 'crm', 'quotes', 'installments', 'invoices', 'expense-vouchers', 'workshop', 'services', 'branches', 'transfers', 'z-report', 'balance-sheet', 'executive-analytics', 'stock-audit', 'data-hub', 'alerts', 'ai-assistant', 'settings-ai', 'logs', 'price-check', 'users'];
  if (role !== 'SUPER_ADMIN' && userPermissionsRaw) {
    try {
      ...
      allowedPermissions = ['dashboard', 'prices', 'stocks', 'transactions', 'suppliers', 'purchases', 'customers', 'loyalty', 'crm', 'quotes', 'installments', 'invoices', 'expense-vouchers', 'workshop', 'services', 'branches', 'transfers', 'z-report', 'balance-sheet', 'executive-analytics', 'stock-audit', 'data-hub', 'alerts', 'ai-assistant', 'settings-ai', 'logs', 'price-check', 'users'];
    }
  }
