      ...
      <header className="sticky top-0 z-30 bg-gray-950/80 backdrop-blur-md border-b border-gray-800/80 px-3 sm:px-6 py-3 sm:py-4 flex flex-wrap items-center justify-between gap-3 sm:gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-400">
              ParaPuan, Otomatik RFM Segmentasyonu, Özel Gün Kutlamaları & Emanet Altın Kasası
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          ...
          <button
            ...
            disabled={loading}
            className="px-3.5 py-2 bg-purple-600/20 hover:bg-purple-600/30 border border-purple-500/40 text-purple-300 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all disabled:opacity-50"
          >
          ...
          <button
            ...
            className="px-3.5 py-2 bg-yellow-500 hover:bg-yellow-400 text-black rounded-xl text-xs font-black flex items-center gap-1.5 transition-all shadow-lg shadow-yellow-500/20"
          >
            <Scale size={14} />
            Emanet Altın Al
          </button>
      ...
      <main className="p-3.5 sm:p-6 max-w-[1920px] mx-auto w-full flex flex-col gap-4 sm:gap-6 min-w-0">
          ...
          <div className={`${THEME.GLASS_CARD} p-4 flex flex-col justify-between border-l-4 border-l-yellow-500`}>
            ...
            <div>
              <div className="text-2xl font-black font-mono text-yellow-400">
                {totalPoints.toLocaleString('tr-TR', { maximumFractionDigits: 0 })} Puan
              </div>
              <div className="mt-1 text-[11px] text-gray-400">
                Değer: <span className="font-bold text-white">₺{totalPoints.toLocaleString('tr-TR', { minimumFractionDigits: 2 })}</span>
              </div>
            </div>
          </div>

          {/* KART 2: ŞAMPİYON MÜŞTERİLER */}
          <div className={`${THEME.GLASS_CARD} p-4 flex flex-col justify-between border-l-4 border-l-emerald-500`}>
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-bold text-gray-400">Şampiyon Müşteriler (VIP)</span>
            ...
            <div>
              <div className="text-2xl font-black font-mono text-emerald-400">
                {championsCount} Müşteri
              </div>
              <div className="mt-1 text-[11px] text-emerald-300/80">
                En Yüksek Frekans & Hacimli Kitle
              </div>
            </div>
          </div>

          {/* KART 3: YAKLAŞAN ÖZEL GÜNLER */}
          <div className={`${THEME.GLASS_CARD} p-4 flex flex-col justify-between border-l-4 border-l-purple-500`}>
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-bold text-gray-400">Yaklaşan Özel Günler</span>
            ...
            <div>
              <div className="text-2xl font-black font-mono text-purple-300">
                {upcomingCount} Etkinlik
              </div>
              <div className="mt-1 text-[11px] text-gray-400">
                Gelecek 15 Gün İçinde Kutlanacak
              </div>
            </div>
          </div>

          {/* KART 4: EMANET KASASI (HAS ALTIN) */}
          <div className={`${THEME.GLASS_CARD} p-4 flex flex-col justify-between border-l-4 border-l-blue-500`}>
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-bold text-gray-400">Emanet Altın Kasası</span>
            ...
            <div>
              <div className="text-2xl font-black font-mono text-blue-400">
                {(data.totalEmanetGold || 0).toFixed(3)} gr
              </div>
              <div className="mt-1 text-[11px] text-gray-400">
                {data.deposits.length} Adet Aktif Emanet Kaydı
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`${THEME.GLASS_CARD} flex flex-col overflow-hidden`}>
          <div className="flex border-b border-gray-800 bg-gray-950/40 p-2 gap-2 flex-wrap">
            ...
            >
              <Gift size={14} />
              Özel Günler Takvimi ({data.upcomingEvents.length})
            </button>
            <button
            ...
            >
              <Scale size={14} />
              Emanet Altın Kasası ({data.deposits.length})
            </button>
          </div>
              ...
              <div className="flex items-center justify-between gap-3 flex-wrap">
                <div className="relative flex-1 max-w-sm">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3.5 py-2 bg-gray-900 border border-gray-800 rounded-xl text-xs text-white focus:outline-none focus:border-yellow-500"
                  />
                </div>
                      ...
                      filteredCustomers.map((c) => {
                        ...
                        return (
                          <tr key={c.id} className="hover:bg-gray-900/30 transition-colors">
                            ...
                            <td className="p-3.5 text-gray-400 font-mono">{c.phone || '—'}</td>
                            <td className="p-3.5">
          ...
          {activeTab === 'points' && (
            <div className="p-4 flex flex-col gap-6">
                  ...
                  return (
                    <div key={key} className={`${THEME.GLASS_CARD} p-4 border ${cfg.border} ${cfg.bg} flex flex-col justify-between`}>
                      ...
                      <div className="mt-4 pt-3 border-t border-gray-800/80 flex items-center justify-between text-xs">
                        <span className="text-gray-400">Aktif Üye Sayısı:</span>
              ...
              <div className="border border-gray-800/80 rounded-xl overflow-hidden">
                ...
                <table className="w-full text-left text-xs">
                  <thead className="bg-gray-900/30 text-gray-400 text-[10px] uppercase font-bold border-b border-gray-800">
                    <tr>
                      <th className="p-3.5">Müşteri</th>
                    ...
                    {data.upcomingEvents.length === 0 ? (
                      ...
                      data.upcomingEvents.map((ev, idx) => (
                        <tr key={idx} className="hover:bg-gray-900/30 transition-colors">
                          ...
                          <td className="p-3.5 font-mono text-gray-400">{ev.phone || '—'}</td>
                          <td className="p-3.5">
                  ...
                  <tbody className="divide-y divide-gray-800/60 font-medium text-gray-300">
                    {data.deposits.length === 0 ? (
                      ...
                      data.deposits.map((dep) => (
                        <tr key={dep.id} className="hover:bg-gray-900/30 transition-colors">
                          ...
                          <td className="p-3.5 text-gray-200">{dep.itemDescription}</td>
                          <td className="p-3.5 text-right font-mono text-gray-400">{dep.carat || 24}K</td>
                          <td className="p-3.5 text-right font-mono font-bold text-white">
                          ...
                          <td className="p-3.5 text-gray-400 max-w-xs truncate">{dep.notes || '—'}</td>
                        </tr>
                      ))
                    )}
                  </tbody>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            ...
            >
              <div className="flex items-center justify-between pb-3 border-b border-gray-800">
                ...
                <button onClick={() => setIsPointModalOpen(false)} className="text-gray-400 hover:text-white">
                  <X size={18} />
                </button>
              </div>

              <div className="p-3 bg-gray-900 border border-gray-800 rounded-xl text-xs">
                <div className="text-gray-400">Müşteri: <span className="text-white font-bold">{selectedCustomerForPoints.name}</span></div>
                <div className="text-gray-400 mt-1">Mevcut Bakiye: <span className="text-yellow-400 font-mono font-bold">{selectedCustomerForPoints.loyaltyPoints} Puan</span></div>
              </div>

              <form onSubmit={handlePointSubmit} className="flex flex-col gap-3.5 text-xs">
                <div>
                  <label className="block text-gray-400 font-semibold mb-1">İşlem Türü</label>
                  <select
                    value={pointForm.actionType}
                    onChange={(e) => setPointForm({ ...pointForm, actionType: e.target.value as any })}
                    className="w-full px-3.5 py-2 bg-gray-900 border border-gray-800 rounded-xl text-white focus:outline-none focus:border-yellow-500"
                  >
                ...
                <div>
                  <label className="block text-gray-400 font-semibold mb-1">Puan Tutarı *</label>
                  <input
                    type="number"
                    step="1"
                    required
                    ...
                    placeholder="Örn: 250"
                    className="w-full px-3.5 py-2 bg-gray-900 border border-gray-800 rounded-xl text-white font-mono text-sm focus:outline-none focus:border-yellow-500"
                  />
                  <span className="text-[10px] text-gray-500 mt-0.5 block">1 ParaPuan = 1.00 TL İndirim</span>
                </div>

                <div>
                  <label className="block text-gray-400 font-semibold mb-1">İşlem Açıklaması / Gerekçe</label>
                  <input
                    type="text"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            ...
            >
              <div className="flex items-center justify-between pb-3 border-b border-gray-800">
                ...
                <button onClick={() => setIsCongratModalOpen(false)} className="text-gray-400 hover:text-white">
                  <X size={18} />
                </button>
              </div>
              ...
              <div className="p-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl text-xs">
                ...
                <div className="text-gray-400 text-[11px] mt-0.5">Telefon: {selectedEventForCongrat.phone || 'Tanımsız'}</div>
              </div>

              <form onSubmit={handleCongratSubmit} className="flex flex-col gap-3.5 text-xs">
                <div>
                  <label className="block text-gray-400 font-semibold mb-1">Tanımlanacak Hediye ParaPuan (TL)</label>
                  <input
                    type="number"
                    step="1"
                    ...
                    placeholder="250"
                    className="w-full px-3.5 py-2 bg-gray-900 border border-gray-800 rounded-xl text-white font-mono text-sm focus:outline-none focus:border-emerald-500"
                  />
                  <span className="text-[10px] text-gray-500 mt-0.5 block">0 bırakırsanız puan yüklenmez, yalnızca kutlama mesajı üretilir.</span>
                </div>

                <div>
                  <label className="block text-gray-400 font-semibold mb-1">İndirim Kupon Kodu (Opsiyonel)</label>
                  <input
                    type="text"
                    value={congratForm.discountCode}
                    onChange={(e) => setCongratForm({ ...congratForm, discountCode: e.target.value })}
                    placeholder="OZELGUN10"
                    className="w-full px-3.5 py-2 bg-gray-900 border border-gray-800 rounded-xl text-white focus:outline-none focus:border-emerald-500"
                  />
                </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            ...
            >
              ...
              <form onSubmit={handleDepositSubmit} className="flex flex-col gap-3.5 text-xs">
                <div>
                  <label className="block text-gray-400 font-semibold mb-1">Müşteri Seçin *</label>
                  <select
                    required
                ...
                <div>
                  <label className="block text-gray-400 font-semibold mb-1">Emanet Altın Tanımı *</label>
                  <input
                    type="text"
                    required
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="block text-gray-400 font-semibold mb-1">Gramaj (gr) *</label>
                    <input
                      type="number"
                      step="0.001"
                      required
                  ...
                  <div>
                    <label className="block text-gray-400 font-semibold mb-1">Ayar (K)</label>
                    <select
                      value={depositForm.carat}
                      onChange={(e) => setDepositForm({ ...depositForm, carat: e.target.value })}
                      className="w-full px-3 py-2 bg-gray-900 border border-gray-800 rounded-xl text-white focus:outline-none focus:border-yellow-500"
                    >
                ...
                <div>
                  <label className="block text-gray-400 font-semibold mb-1">Özel Notlar</label>
                  <input
                    type="text"
